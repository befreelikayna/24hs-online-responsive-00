...
export const DesktopAdminSidebar = ({ isCollapsed }: DesktopAdminSidebarProps) => {
  ...
  return (
    <aside
      className={`hidden md:block fixed left-0 top-[60px] h-[calc(100vh-108px)] bg-gradient-to-b from-[#1a1f2c]/90 via-[#2C2F3E]/85 to-[#1a1f2c]/90 backdrop-blur-md border-r border-[#D6BCFA]/10 shadow-2xl rounded-br-3xl rounded-tr-3xl border-t border-t-[#D6BCFA]/10 transition-all duration-300 ease-in-out ${
